...
def get_predicted_value(patient_symptoms):
    ...
    if unknown_symptoms:
        return f"Unknown symptom(s): {', '.join(unknown_symptoms)}. Please check spelling or try something like 'headache, fatigue, nausea'."
...
def home():
    if request.method == 'POST':
        ...
        if symptoms =="Symptoms":
            ...
            # Check if prediction returned an error message
            if "Unknown symptom" in predicted_disease:
